...
namespace RxWebSampleApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(RxWebSampleApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(RxWebSampleApp.Models.Main.LanguageContent.ComponentLanguageContents))]
